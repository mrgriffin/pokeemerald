...
static void CreateCancelConfirmWindows(bool8);
...
static void CreatePartyMonIconSpriteParameterized(u16, u32, struct PartyMenuBox *, u8, bool32);
...
static void BufferBattlePartyOrder(u8 *, u8);
