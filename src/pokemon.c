...
{
    FOREACH_SPECIES_IN_NATIONAL_DEX_ORDER(SPECIES_TO_HOENN)
};

// Assigns all species to the National Dex Index (Summary No. for National Dex)
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    FOREACH_SPECIES_IN_NATIONAL_DEX_ORDER(SPECIES_TO_NATIONAL)
};

// Assigns all Hoenn Dex Indexes to a National Dex Index
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    FOREACH_SPECIES_IN_NATIONAL_DEX_ORDER(HOENN_TO_NATIONAL)
};
