...
static void Contest_StartTextPrinter(const u8 *, bool32);
...
static void BlinkContestantBox(u8, bool8);
...
static bool8 UpdateConditionStars(u8, bool8);
...
EWRAM_DATA bool8 gCurContestWinnerIsForArtist = FALSE;
